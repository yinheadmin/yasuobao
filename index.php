...
if ($ip=="0" ||  $ip=="5"|| $ip=="6" || $ip=="7" || $ip=="8" || $ip=="9")
{
 ...
 }else
 {
  ...
  <div style="display:none">
  <script type="text/javascript">var cnzz_protocol = (("https:" == document.location.protocol) ? "https://" : "http://");document.write(unescape("%3Cspan id='cnzz_stat_icon_1277642438'%3E%3C/span%3E%3Cscript src='" + cnzz_protocol + "s5.cnzz.com/z_stat.php%3Fid%3D1277642438' type='text/javascript'%3E%3C/script%3E"));</script>
  </div>
